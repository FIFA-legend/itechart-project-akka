...
import com.itechart.project.repository.{CountryRepository, FormationRepository, LeagueRepository}
import com.itechart.project.route.{CountryRouter, FormationRouter, LeagueRouter}
import com.itechart.project.service.{CountryService, FormationService, LeagueService}
  ...
  databaseSettingsEither match {
    ...
    case Right(databaseConfiguration) =>
      ...
      Http()
        ...
        .bind(countryRouter.countryRoutes ~ formationRouter.formationRoutes ~ leagueRouter.leagueRoutes)
  }
